...
public class RecipeController {
    ...
    public ResponseEntity<GenericResponse> getRecipesByUser(@RequestHeader("Authorization") String authHeader) {
        ...
        return ResponseEntity.ok(new GenericResponse("msg sent to RabbitMQ"));
    }

    // Endpoint: Récupérer les recettes par recipeId
    @GetMapping("/getbyrecipe/{recipeId}")
    public ResponseEntity<GenericResponse> getRecipesByRecipe(@PathVariable Integer recipeId, @RequestHeader("Authorization") String authHeader){
        ...
        return ResponseEntity.ok(new GenericResponse("message sent to the rabbitMQ"));
    }
